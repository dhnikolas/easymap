...
import (
	...
	"github.com/dhnikolas/easymap/pkg/diff"
)
...
func ProcessGofmt(filename string, in io.Reader, out io.Writer, stdin bool) error {
	return processFile(filename, in, out, stdin)
}
